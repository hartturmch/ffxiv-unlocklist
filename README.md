...
```powershell
dotnet build .\dalamud-plugin\VaelarisUnlockList\VaelarisUnlockList.csproj -c Debug
```
...
Plugin data is generated from site data into:

```text
dalamud-plugin/VaelarisUnlockList/Data/unlockables.json
```
